...
Data reviewed in this repository was provided to CBEP directly by staff at the
Maine Beaches Program.  A significant portion of the data, however, is also 
available for download and review via the 
[Maine Beaches Program Web page](http://www.mainecoastdata.org/public/CurrentBeachStatus.aspx).

The data consists principally of "Enterococci" bacteria counts from regular
beach monitoring at several beaches in and around Casco Bay.
